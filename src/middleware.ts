...
const PROTECTED = ['/dashboard', '/assistant', '/planner', '/notes', '/files', '/content-studio', '/code-studio', '/document-builder', '/invoices', '/reminders', '/settings', '/billing', '/admin', '/proposal', '/my-stack', '/autopilot', '/life-hub', '/ai-tools'];
