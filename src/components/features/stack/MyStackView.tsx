...
const STACK_MAP: Record<string, ToolData> = {
  ...
  'codesandbox':    { feature: 'Code Studio (Soon)', description: 'In-browser IDE with live preview and AI codegen', icon: '💻', monthlyUSD: 12, plan: 'pro' },
  'replit':         { feature: 'Code Studio (Soon)', description: 'Online IDE with Python, Node.js execution and deploy', icon: '💻', monthlyUSD: 25, plan: 'pro' },
  'stackblitz':     { feature: 'Code Studio (Soon)', description: 'In-browser IDE with live preview', icon: '💻', monthlyUSD: 0, plan: 'pro' },
  'codepen':        { feature: 'Code Studio (Soon)', description: 'HTML/CSS/JS playground with live preview', icon: '💻', monthlyUSD: 8, plan: 'pro' },
  'jsbin':          { feature: 'Code Studio (Soon)', description: 'JS/HTML sandbox with live preview', icon: '💻', monthlyUSD: 0, plan: 'pro' },
  'glitch':         { feature: 'Code Studio (Soon)', description: 'Online code editor with hosting', icon: '💻', monthlyUSD: 0, plan: 'pro' },
  'gitpod':         { feature: 'Code Studio (Soon)', description: 'Cloud IDE for code projects', icon: '💻', monthlyUSD: 9, plan: 'pro' },
  'github codespaces':{ feature: 'Code Studio (Soon)', description: 'Cloud-based development IDE', icon: '💻', monthlyUSD: 9, plan: 'pro' },
  'githubcodespaces':{ feature: 'Code Studio (Soon)', description: 'Cloud-based development IDE', icon: '💻', monthlyUSD: 9, plan: 'pro' },
  'cursor':         { feature: 'Code Studio (Soon)', description: 'AI-first code editor with world-class codegen', icon: '💻', monthlyUSD: 20, plan: 'pro' },
  'v0':             { feature: 'Code Studio (Soon)', description: 'AI code generation and live preview', icon: '💻', monthlyUSD: 20, plan: 'pro' },
  'bolt':           { feature: 'Code Studio (Soon)', description: 'AI-powered code generation and IDE', icon: '💻', monthlyUSD: 20, plan: 'pro' },
  'bolt.new':       { feature: 'Code Studio (Soon)', description: 'AI-powered code generation and IDE', icon: '💻', monthlyUSD: 20, plan: 'pro' },
  'lovable':        { feature: 'Code Studio (Soon)', description: 'AI app builder with code editor', icon: '💻', monthlyUSD: 20, plan: 'pro' },
  'webflow':        { feature: 'Code Studio (Soon)', description: 'Visual web design and CMS builder', icon: '💻', monthlyUSD: 23, plan: 'pro' },
  'framer':         { feature: 'Code Studio (Soon)', description: 'Interactive web design and publish tool', icon: '💻', monthlyUSD: 20, plan: 'pro' },
  'wix':            { feature: 'Code Studio (Soon)', description: 'Website builder with AI assistance', icon: '💻', monthlyUSD: 16, plan: 'pro' },
  'squarespace':    { feature: 'Code Studio (Soon)', description: 'Website builder with design templates', icon: '💻', monthlyUSD: 16, plan: 'pro' },
  'github':         { feature: 'Code Studio (Soon)', description: 'Code repository and project hosting', icon: '💻', monthlyUSD: 4, plan: 'pro' },
  // Proposals
              ...
              <div>
                {savingsLocal >= 0 ? (
                  ...
                  <>
                    ...
                    <p style={{ fontSize: '12px', color: 'hsl(240 5% 50%)', marginTop: '3px' }}>
                      AI Assistant + Autopilot + Planner + Notes + Reminders + Doc Builder + Life Hub all included.
                    </p>
                  </>
                )}
              </div>
